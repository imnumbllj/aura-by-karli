...
function StatCard({ icon: Icon, label, value, accent, sub }) {
  return (
    ...
    >
      <div style={{ width: 34, height: 34, borderRadius: 9, background: accent + '18', border: `1px solid ${accent}28`, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
